...
| `decision_path` | `gafime_cpu` path discovery and membership expansion | `gafime_cpu`, CUDA, ROCm, Metal continuous scoring; optional compact CUDA RT score ABI is reported separately | Continuous scoring only |
